...
The best-supported model of availability from the removal analysis indicated an effect of day-of-the-year on availability, although the improvement over the null model was minor (@tbl-removalAIC).
...
Assuming independence in the probabilities of availability and perceptibility, their product provides an estimate of overall average detectability: 0.14 (probability of availability) \* 0.06 (probability a lark is detected given that it sings) = 0.01. Because of the seasonal changes in both availability and perceptibility, detectability will be higher than this earlier in the year but lower later in the year. Estimates of abundance based on this value will likely be exceedingly high given the low estimated probability of detection.
...
The obvious problem is the extremely low estimates of detectability. This is producing unreasonable abundance estimates. This is probably driven largely by the very small sample size and the relative paucity of detections. Hard to much with \~30 birds a year. Model fit is OK, though. Availability is probably the key driving factor and may be influencing also the apparent seasonal decline in perceptibility. Given the decline in both with day, can we start earlier? Also, probably need a way to increase our encounter rate.
